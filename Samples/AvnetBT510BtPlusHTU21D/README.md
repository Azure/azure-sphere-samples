...
Example:  The message below was generated from two BT510s.  One named Basement and one named Coach.  The "temp" and "humidity" data was read from the TE HTU21D sensor.
