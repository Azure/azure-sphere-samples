...
### Add your example certificates to the application
   ...
   **Caution!** Because [Certificate IDs](https://learn.microsoft.com/azure-sphere/app-development/certstore#certificate-ids) are system-wide, an `az sphere` command or a function call that adds a new certificate can overwrite a certificate that was added by an earlier
