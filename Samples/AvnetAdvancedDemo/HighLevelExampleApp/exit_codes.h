...
typedef enum {
    ...
    // M4 intercore comms exit codes
    ExitCode_Init_Invalid_Number_Real_Time_Apps = 50,
    ExitCode_Init_Open_Socket = 51,

    ExitCode_TelemetryTimer_Consume = 52,
    ExitCode_Init_TelemetrytxIntervalr = 53,
    ExitCode_Init_StatusLeds = 54,

    ExitCode_Init_LocationFromIPTimer = 55,
