...
1. Clone the [Azure Sphere samples](https://github.com/Azure/azure-sphere-samples) repo and find the SpiSimplePrototype sample.
1. In Visual Studio, open LSM6DS3_SPI.sln and press F5 to compile and build the solution and load it onto the device for debugging.
