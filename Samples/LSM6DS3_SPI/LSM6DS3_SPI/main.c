...
// uses the Azure Sphere SPI APIs to display data from an accelerometer connected via SPI.
//
...
///	This also works as a smoke test to ensure the MT3620 can talk to the SPI device.
/// </summary>
