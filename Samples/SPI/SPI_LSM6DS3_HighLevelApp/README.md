...
1. Enable [application development](https://docs.microsoft.com/azure-sphere/install/qs-blink-application#prepare-your-device-for-development-and-debugging), if you have not already done so:
