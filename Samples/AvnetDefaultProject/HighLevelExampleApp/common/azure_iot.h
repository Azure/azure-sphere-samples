...
extern IoTHubClientAuthenticationState iotHubClientAuthenticationState;
...
typedef enum {
    ...
    /// <summary>
    /// The operation could not be performed as the device was not authenticated to the 
    /// IoT Hub
    /// </summary>
    AzureIoT_Result_NotAuthenticated,

    /// <summary>
    /// The operation could not be performed as the send call failed
    /// </summary>
    AzureIoT_Result_SendReportedState_Failed,
    /// <summary>
