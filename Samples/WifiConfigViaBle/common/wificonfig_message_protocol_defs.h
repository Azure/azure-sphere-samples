...
/// <summary>
///     Data structure for the body of a <see cref="WifiConfigureMessageProtocol_GetNewWifiDetailsRequestId" />
///     response message message. This structure describes a found Wi-Fi network.
/// </summary>
typedef struct {
    /// <summary>
    ///     Security type as defined by <see cref="WifiConfig_Security" /> in applibs/wificonfig.h.</summary>
    /// </summary>
...
/// <summary>
///     Data structure for the body of a <see cref="WifiConfigureMessageProtocol_SetWifiStatusRequestId" />
///     request message. This structure describes the current status of the Wi-Fi connection on the Azure Sphere device.
/// </summary>
typedef struct {
    /// <summary>
    ///     The connection status - one of <see cref="WifiConfigureMessageProtocol_NoConnection" />,
    ///     <see cref="WifiConfigureMessageProtocol_WifiConnected" /> or <see cref="WifiConfigureMessageProtocol_InternetConnected" />
    /// </summary>
...
/// <summary>
///     Data structure for the body of a <see cref="WifiConfigureMessageProtocol_SetWifiScanResultsSummaryRequestId"/> 
///     request message.
/// </summary>
typedef struct {
    /// <summary>The result of the scan - 0 indicates success; any other value indicates an error.</summary>
    uint8_t scanResult;
...
/// <summary>
///     Data structure for the body of a <see cref="WifiConfigureMessageProtocol_SetNextWiFiScanResultRequestId"/>
///     request message. This structure describes a network as found during a network scan.
/// </summary>
typedef struct {
    /// <summary>
    ///     Security type as defined by <see cref="WifiConfig_Security" /> in
