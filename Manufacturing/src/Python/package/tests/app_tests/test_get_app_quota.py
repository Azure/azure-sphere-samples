...
def test__get_app_quota__null_component_throws_validation_error():
    ...
    assert error.exconly() == 'microsoft_azure_sphere_deviceapi.exceptions.ValidationError: ERROR: Cannot get the app quota, invalid component ID.'
...
def test__get_app_quota__valid_non_existent_component_throws_validation_error():
    ...
    assert error.exconly() == 'microsoft_azure_sphere_deviceapi.exceptions.DeviceError: ERROR: This resource is unavailable on this device. Application is not present'
