...
def test__add_certificate__null_certificate_location_throws_validation_error():
    ...
    assert error.exconly() == 'azuresphere_device_api.exceptions.ValidationError: ERROR: Cannot add certificate, certificate path is null or empty.'
...
def test__add_certificate__invalid_certificate_throws_validation_error():
    ...
    assert error.exconly() == 'azuresphere_device_api.exceptions.ValidationError: ERROR: Cannot add certificate, certificate path is invalid.'
...
def test__add_certificate__null_certificate_id_throws_validation_error():
    ...
    assert error.exconly() == 'azuresphere_device_api.exceptions.ValidationError: ERROR: Cannot add certificate, certificate ID is null or empty.'
...
def test__add_certificate__null_cert_type_throws_validation_error():
    ...
    assert error.exconly() == 'azuresphere_device_api.exceptions.ValidationError: ERROR: Cannot add certificate, cert type is invalid.'
...
def test__add_certificate__client_null_private_key_throws_validation_error():
    ...
    assert error.exconly() == 'azuresphere_device_api.exceptions.ValidationError: ERROR: Cannot add certificate, private key path is invalid.'
...
def test__add_certificate__client_null_password_throws_validation_error():
    ...
    assert error.exconly() == 'azuresphere_device_api.exceptions.ValidationError: ERROR: Cannot add certificate, invalid password.'
